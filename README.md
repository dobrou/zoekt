...
Downloading:
    ...
    go get github.com/dobrou/zoekt/

Indexing:

    go install github.com/dobrou/zoekt/cmd/zoekt-index
    $GOPATH/bin/zoekt-index .

Searching

    go install github.com/dobrou/zoekt/cmd/zoekt
    $GOPATH/bin/zoekt 'ngram f:READ'

Indexing git repositories:

    go install github.com/dobrou/zoekt/cmd/zoekt-git-index
    $GOPATH/bin/zoekt-git-index -branches master,stable-1.4 -prefix origin/ .

Indexing repo repositories:

    go install github.com/dobrou/zoekt/cmd/zoekt-{repo-index,mirror-gitiles}
...
Starting the web interface
    ...
    go install github.com/dobrou/zoekt/cmd/zoekt-webserver
...
Zoekt comes with a small service management program:
    ...
    go install github.com/dobrou/zoekt/cmd/zoekt-indexserver
